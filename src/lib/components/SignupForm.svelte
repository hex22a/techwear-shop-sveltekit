...
<form onsubmit={handleSubmit}>
	...
	<input class="text-black block border w-full rounded-full py-3.5 px-14 mb-3" name="username" id="username" type="text"/>
	<hr class="my-4"/>
	<button type="submit" class="block border w-full rounded-full py-3.5 px-14 mb-3 bg-black text-white">Sign Up</button>
</form>
